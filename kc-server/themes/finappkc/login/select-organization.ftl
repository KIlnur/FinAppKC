...
<#assign xKeycloakify={
    ...
    "ftlTemplateFileName": "select-organization.ftl",
    "themeType": "login",
    "themeName": "finappkc",
    "keycloakifyVersion": "11.14.2",
    "themeVersion": "1.0.0",
    "resourcesPath": ""
}>
...
<base href="${xKeycloakify.resourcesPath}/dist/">
    ...
    <meta http-equiv="Content-Security-Policy" content="
      ...
      ">
    <link rel="icon" type="image/svg+xml" href="${xKeycloakify.resourcesPath}/dist/logo.svg">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&amp;display=swap" rel="stylesheet">
    <title>FinApp</title>
    <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-mPjD09O2.js"></script>
    <link rel="modulepreload" crossorigin="" href="${xKeycloakify.resourcesPath}/dist/assets/vendor-jVyfcstf.js">
  </head>
  <body>
    <div id="root"></div>
